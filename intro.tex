...
%  \footnote{That many seemingly sensible problems lead to such results, at least in the context of elementary mathematics, is not only a frustration for students, but a failing of mathematics.}
  ...
  Measuring the temperature of the meat with our thermometer can be described by an integral of $f$, weighted by $\varphi$: $T_\text{measured} = \int_0^\ell f(x)\varphi(x) dx$, where $\ell$ is the length of the thermometer. %TODO:endpoints; graphs

...
%  \footnote{That many seemingly sensible problems lead to such results, at least in the context of elementary mathematics, is not only a frustration for students, but a failing of mathematics.}
  ...
  In the case of \emph{functions}, an endlessly troublesome issue, at least for students of calculus, is differentiation -- finding the rate of change of a function's output as the input varies.
  ...
  Measuring the temperature of the meat with our thermometer can be described by an integral of $f$, weighted by $\varphi$: $T_\text{measured} = \int_0^\ell f(x)\varphi(x) dx$, where $\ell$ is the length of the thermometer. %TODO: graphs
  ...
  %TODO: example: dirac delta

  %TODO: a word on layout of the following material

  %TODO: a word on theory of mathematics; something about building on work of others vs. starting from first principles, and the necessity of the former

      ...
      \subsection{Projective Limits}
        ...
        \begin{claim}
          ...
          \begin{proof}
            ...
            \begin{displaymath}
              \xymatrix{
                X \ar[r]^j \ar@/^40pt/[rrr]_{\varphi_1} \ar@/^50pt/[rrrr]^{\varphi_0}
            ...
            Thus define $f:Z\rightarrow X$ by $f(z) = F(z)$, so we have the diagram with commuting solid or dashed (but not dotted) triangles
            \begin{displaymath}
              \xymatrix{
                X \ar[r]^j \ar@/^40pt/[rrr]_{\varphi_1} \ar@/^50pt/[rrrr]^{\varphi_0}
                & Y \ar@/^20pt/@{..>}[rr]_{p_1} \ar@/^30pt/@{..>}[rrr]^{p_0}

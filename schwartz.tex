\input{chpreamble}
  ...
  %        Thus the evaluation functional is continuous.
    ...
    \subsection{Spaces of decaying functions}
      ...
      The definition of $C^k_\ell$ is slightly ugly -- secretly we want the $(1+x^2)$ to be an $x$, but importantly $(1+x^2)^\ell\ge1$ for all $x$ and $\ell$.
...
%      Furthermore, by \cref{thm:cofinalisom} we need only take the limit of a \emph{cofinal, directed} subfamily of the $C^k_\ell$, as it will be homeomorphic to the limit of the whole collection.

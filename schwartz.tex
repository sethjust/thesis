    ...
    \section{Consequences of Topology on \S}
      ...
      \begin{claim}
        ...
        \begin{proof}
          ...
          Composing such functions gives us a continuous map $D:C^k_\ell\rightarrow C^i_j$ for any $(k,\ell)>(i,j)$ that takes a function in one space to its derivative in another.
          Thus we have the commutative diagram of continuous maps
          \begin{displaymath}
            \xymatrix{
              \S \ar@/^20pt/[rr]_{\varphi^k_\ell} \ar@/^30pt/[rrr]^{\varphi^i_j} && C^k_\ell \ar[r] & C^i_j \ar[r] & \cdots \\
              \S \ar@/_20pt/[rr]^{\varphi^k_\ell} \ar@/_30pt/[rrr]_{\varphi^i_j} & \cdots \ar[r] \ar[ur]^D & C^k_\ell \ar[r] \ar[ur]^D & C^i_j \ar[ur]^D \\
            }
          \end{displaymath}
          ...
          \end{displaymath}
          These maps take Schwartz functions to their derivatives in some $C^k_\ell$ and commute with the inclusions $\varphi^k_\ell:\S\rightarrow C^k_\ell$.
          Thus the induced map $D:\S\rightarrow\S$ takes functions to their derivatives, and is continuous.
        \end{proof}
      \end{claim}

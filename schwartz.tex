...
%          Thus when $f$ and $g$ are close in $C^k_0$, $Df$ and $Dg$ are close in $C^{k-1}_0$.
      ...
      \begin{proof}
        ...
        This proof is similar to \thref{thm:ck0complete}, with the added complication(s) of proving decay along with differentiability.
...
%        We want to show that the sequence is Cauchy in another norm, as in \thref{thm:c0lcomplete}.
        ...
        From \thref{thm:ck0complete} we then see that $\{f_i\}\rightarrow f$ in $C^1_0$ and $\{f_i'\}\rightarrow g$ in $C^0_0$ with $f'=g$.

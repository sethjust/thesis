...
%      Furthermore, by \thref{thm:cofinalisom} we need only take the limit of a \emph{cofinal, directed} subfamily of the $C^k_\ell$, as it will be homeomorphic to the limit of the whole collection.
      ...
      \end{rmk}
      \begin{cor}
        As the projective limit of Banach spaces, \S is a \emph{Fr\'echet} space by definition.%
        \footnote{
          A more orthodox definition of a Fr\'echet space is a topological vector space which is complete in the topology induced by a translation-invariant norm or by a family of seminorms.
          These definitions are equivalent; see \todo{cite paul, or just write this up in an appendix}.
%          See also that our construction of \S immediately gives us a family of seminorms.
%          Recall that a seminorm is a norm that may not separate points.
        }
      \end{cor}

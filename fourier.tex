...
%          \F(f_x) &= \frac{1}{|x|}(\F f)_{x^{-1}}
      ...
      \begin{example}[The heat equation]
        ...
        \begin{figure}[p]
          ...
          \end{center}
          \caption{An example solution to the heat equation for a square pulse of heat, calculated from the function $u(x,t)$ \cref{eq:heatsoln} derived in \cref{ex:heateq}.}
          \label{fig:heateq}
        \end{figure}
      \end{example}
